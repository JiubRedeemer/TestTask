...
CREATE TABLE CLIENT(
    ...
    FIO VARCHAR(255),EMAIL VARCHAR(255),
    NAME VARCHAR(255),PASSPORT VARCHAR(255),
    PATRONYMIC VARCHAR(255),PHONE VARCHAR(255),
    SURNAME VARCHAR(255),IDBANKCLIENT VARCHAR(255),
...
CLIENTFULLNAME VARCHAR(255),CREDITNAME VARCHAR(255),
CREDITSUM BIGINT,PERCENT DOUBLE,START DATE,TIME BIGINT,
